...
| Kesintisiz oynatma | HLS/DASH yayınlarını Media3, YouTube ve resmî yayın hedeflerini uygulama içi oynatıcıyla açma |
...
- Alternatif sayfadaki HLS adresini reklam katmanını ve WebView'ı atlayarak Media3 ile açma
- YouTube iframe'lerini ve resmî yayın hedeflerini reklamlı kaynak sayfa yerine doğrudan uygulama
  içindeki güvenli oynatıcıda açma
- Tarayıcı veya YouTube uygulaması gerektirmeden alternatif yayın oynatma
...
- Bozuk akışta alternatif yayın adresini isteğe bağlı çözümleme
...
- **Sürüm sayfası:** [v3.6.1](https://github.com/KayaJR356/Turkey-TV/releases/tag/v3.6.1)
...
Bir kanal için HLS/DASH/MP4 adresi bulunursa uygulama yayını doğrudan Media3 ile açar. YouTube
veya resmî yayın sayfası kullanan kanallar reklamlı kaynak sayfa atlanarak uygulama içindeki
güvenli oynatıcıda açılır; cihazda ayrıca tarayıcı veya YouTube uygulaması gerekmez. Kanal hiçbir
durumda katalogdan silinmez.
...
- [x] Tam kaynak kataloğu ve HLS/YouTube/resmî yayın kaynağına uygun oynatma yolu
